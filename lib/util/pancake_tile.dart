...
class pancakeTile extends StatefulWidget {
  ...
  @override
  State<pancakeTile> createState() => _pancakeTileState();
}
          ...
          "messages": [
            {
              "role": "system",
              "content":
                  "Provide main ingredients of ${widget.pancakeFlavor} pancake only nothing else."
            }
          ],
        },
      ),
